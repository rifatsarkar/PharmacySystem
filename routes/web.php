...
Route::get('/ajax-emai/product/managel-check/{id}',[
    'uses' => 'checkoutController@ajaxEmailCheck',
    'as' => 'ajax-email-check'
]);

Route::get('/pay-bill/{id}',[
    'uses' => 'OrderController@payBill',
    'as' => 'pay-bill'
]);

Route::post('/status-action/{id}',[
    'uses' => 'OrderController@statusAction',
    'as' => 'status-action'
]);
...
Route::post('/customer-login-shop',[
    'uses' => 'BigStoreController@customerLoginShop',
    'as' => 'customer-login-new'
]);
